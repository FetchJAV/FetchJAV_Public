...
def test_current_version_and_global_smalltool_copy_are_complete():
    assert gui_modern.APP_VERSION == jable_smalltool.APP_VERSION == '0.1.7'
    required = {
    ...
    for language, strings in locales.STRINGS.items():
        assert strings['version_label'] == 'v0.1.7', language
