...
CATEGORY_I18N = {
    ...
    '最新上市': {'en': 'Latest Release', 'zh': '最新上市', 'zh-Hans': '最新上市', 'ja': '最新リリース'},
    '最新上傳': {'en': 'Latest Upload', 'zh': '最新上傳', 'zh-Hans': '最新上传', 'ja': '最新アップロード'},
    '本日排行': {'en': 'Daily Popular', 'zh': '本日排行', 'zh-Hans': '本日排行', 'ja': 'デイリー人気'},
    '本週排行': {'en': 'Weekly Popular', 'zh': '本週排行', 'zh-Hans': '本周排行', 'ja': '週間人気'},
    '本月排行': {'en': 'Monthly Popular', 'zh': '本月排行', 'zh-Hans': '本月排行', 'ja': '月間人気'},
    '觀看次數': {'en': 'Most Viewed', 'zh': '觀看次數', 'zh-Hans': '观看次数', 'ja': '視聴回数'},
    '讚好比例': {'en': 'Top Rated', 'zh': '讚好比例', 'zh-Hans': '点赞比例', 'ja': '高評価順'},
    '時長最長': {'en': 'Longest Duration', 'zh': '時長最長', 'zh-Hans': '时长最长', 'ja': '再生時間順'},
    'https://hanime.tv/browse/newest': {'en': 'New Releases', 'zh': '新作上市', 'zh-Hans': '新作上市', 'ja': '新作'},
    'https://hanime.tv/browse/recent': {'en': 'Recent Uploads', 'zh': '最近更新', 'zh-Hans': '最近更新', 'ja': '最新更新'},
    'https://hanime.tv/browse/trending': {'en': 'Trending', 'zh': '熱門排行', 'zh-Hans': '热门排行', 'ja': 'トレンド'},
    'https://hanime.tv/browse/views': {'en': 'Most Views', 'zh': '最多觀看', 'zh-Hans': '最多观看', 'ja': '視聴回数順'},
    'https://hanime.tv/browse/likes': {'en': 'Most Likes', 'zh': '最多喜歡', 'zh-Hans': '最多喜欢', 'ja': '高評価順'},
    'https://hanime.tv/browse/tags/uncensored': {'en': 'Uncensored', 'zh': '無碼', 'zh-Hans': '无码', 'ja': '無修正'},
    'https://hanime.tv/browse/tags/creampie': {'en': 'Creampie', 'zh': '中出', 'zh-Hans': '中出', 'ja': '中出し'},
    'https://hanime.tv/browse/tags/blow%20job': {'en': 'Blowjob', 'zh': '口交', 'zh-Hans': '口交', 'ja': 'フェラ'},
    'https://hanime.tv/browse/tags/milf': {'en': 'MILF', 'zh': '人妻/熟女', 'zh-Hans': '人妻/熟女', 'ja': '人妻・熟女'},
    'https://hanime.tv/browse/tags/maid': {'en': 'Maid', 'zh': '女僕', 'zh-Hans': '女仆', 'ja': 'メイド'},
    'https://hanime.tv/browse/tags/elf': {'en': 'Elf', 'zh': '精靈', 'zh-Hans': '精灵', 'ja': 'エルフ'},
    'https://hanime.tv/browse/tags/school%20girl': {'en': 'Schoolgirl', 'zh': '女高中生', 'zh-Hans': '女高中生', 'ja': '女子校生'},
    'https://hanime.tv/browse/tags/vanilla': {'en': 'Vanilla', 'zh': '純愛', 'zh-Hans': '纯爱', 'ja': '純愛'},
    'https://hanime.tv/browse/tags/3d': {'en': '3D', 'zh': '3D', 'zh-Hans': '3D', 'ja': '3D'},
    'https://hanime.tv/browse/tags/cosplay': {'en': 'Cosplay', 'zh': 'Cosplay', 'zh-Hans': 'Cosplay', 'ja': 'コスプレ'},
    'https://hanime.tv/browse/tags/big%20boobs': {'en': 'Big Boobs', 'zh': '巨乳', 'zh-Hans': '巨乳', 'ja': '巨乳'},
    'https://hanime.tv/browse/tags/rape': {'en': 'Rape', 'zh': '強姦', 'zh-Hans': '强奸', 'ja': 'レイプ'},
    'https://hanime.tv/browse/tags/ntr': {'en': 'NTR', 'zh': 'NTR', 'zh-Hans': 'NTR', 'ja': 'NTR'},
    'https://hanime.tv/browse/tags/harem': {'en': 'Harem', 'zh': '後宮', 'zh-Hans': '后宫', 'ja': 'ハーレム'},
    'https://hanime.tv/browse/tags/yuri': {'en': 'Yuri', 'zh': '百合', 'zh-Hans': '百合', 'ja': '百合'},
    'https://hanime.tv/browse/tags/futanari': {'en': 'Futanari', 'zh': '扶他', 'zh-Hans': '扶他', 'ja': 'ふたなり'},
}
