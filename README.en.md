...
<p align="center">
  <strong><a href="https://github.com/DeepanshuK2002/FetchJAV/releases/latest/download/FetchJAV.exe">Download FetchJAV (Recommended)</a></strong>
  ·
  <strong><a href="https://github.com/DeepanshuK2002/FetchJAV/releases/latest/download/JableTV_Modern.exe">Download Modern</a></strong>
  ·
  <a href="https://github.com/DeepanshuK2002/FetchJAV/releases/latest">View the latest release</a>
</p>
...
1. Download [FetchJAV.exe](https://github.com/DeepanshuK2002/FetchJAV/releases/latest/download/FetchJAV.exe) or [JableTV_Modern.exe](https://github.com/DeepanshuK2002/FetchJAV/releases/latest/download/JableTV_Modern.exe).
...
State is stored in `.Jable_smalltool` beside the executable when writable, otherwise in `%APPDATA%\FetchJAV\smalltool`.
...
When opening a [GitHub Issue](https://github.com/DeepanshuK2002/FetchJAV/issues/new), include:
...
See [Releases](https://github.com/DeepanshuK2002/FetchJAV/releases) for version notes and resolved issues.
