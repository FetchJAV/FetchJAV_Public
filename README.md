...
- [Installation](#installation)
  ...
  - [From Source](#from-source-macos--linux--developer)
  - [Docker / NAS Headless](#docker--nas-headless-deployment)
- [Usage](#usage)
  - [GUI Usage](#gui-usage)
  - [CLI Usage](#cli-usage)
  - [Docker CLI](#docker-cli)
  - [Hot Reload (Developer Mode)](#hot-reload-developer-mode)
- [Configuration](#configuration)
  - [Preferences File](#preferences-file)
  - [Key Settings](#key-settings)
  - [Proxy Configuration](#proxy-configuration)
  - [Supported Site Mirrors](#supported-site-mirrors)
- [AI Subtitle Pipeline](#ai-subtitle-pipeline)
  - [Local Offline ASR](#local-offline-asr)
  - [Cloud LLM Translation](#cloud-llm-translation)
  - [Online Subtitle Providers](#online-subtitle-providers)
...
FetchJAV is a feature-rich Python desktop application for downloading, streaming, and subtitle-generating from adult video websites. It is a customized fork of [JableTV-MissAV-Downloader-GUI-2026](https://github.com/Alos21750/JableTV-MissAV-Downloader-GUI-2026) by ALOS, significantly extended with a modern CustomTkinter UI, an AI-powered subtitle pipeline, a built-in video preview player, cross-site metadata aggregation, Docker/NAS headless deployment, and an automated upstream sync system.
...
> **Windows Security Note:** SmartScreen reputation warnings and Defender Antivirus isolation are different events. Please read [Windows Security Guide](./WINDOWS_SECURITY.md) before filing issues. Verify `SHA256SUMS.txt` against GitHub provenance.
...
| Issue | Solution |
|-------|----------|
| **Windows SmartScreen warning** | Right-click → Properties → Unblock, or click "More info" → "Run anyway". See [WINDOWS_SECURITY.md](./WINDOWS_SECURITY.md) |
...
FetchJAV is licensed under the **Apache License, Version 2.0** — see [LICENSE](./LICENSE) for details.
...
FetchJAV 是一款功能豐富的 Python 桌面應用程式，支援從 JableTV、MissAV、SupJav 及其他 30+ 網站下載、串流播放及自動生成字幕。
...
> SmartScreen 信譽提醒與 Defender Antivirus 隔離是不同事件。請先閱讀 [Windows 下載與安全驗證](./WINDOWS_SECURITY.md)：核對 SHA256SUMS.txt 與 GitHub provenance。
