...
# start and gives saved selections stable IDs.
...
def _parse_videos(soup, listing_url=''):
    ...
    # duration and author; the watcher confirms the absolute date from the
...
class Hanime1Browser:
    ...
    def fetch_video_date(cls, url):
        """Return the confirmed absolute date from a watch page, else ''."""
